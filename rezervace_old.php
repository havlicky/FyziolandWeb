...
<div class="container-fluid">
    ...
    <div class="row" id="proc-si-vybrat-prave-nas" style="margin-top: 10px;">
        <div class="col-md-12 text-center nadpis">
            VYZKOUŠEJTE NOVÉ SLUŽBY
            <div class="underline"></div>
        </div>
    </div>                        
        <div class="row bubliny" style="padding-bottom: 30px;">
            <div class="col-lg-12">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-3 col-md-offset-2 text-center" id="title-objednavky">
                            <div>                                    
                                <a href="fyziotrenink.php">Individuální fyziotréninky</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 text-center hidden-sm hidden-xs" id="title-logo">
                            <!--
                            <div>                                    
                                <a href="skupinova-cviceni.php">Individuální fyziotréninky</a>
                            </div>
                            -->
                        </div>
                        ...
                        <div class="col-md-3 text-center" id="title-online">
                            <div style="background-color: grey;">
                                <a href="fyziotrenink.php">Fyziotréninky pro páry</a>
                            </div>                               
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("select[name='service'], select[name='person']").change(function() {
            ...
            if (dateFrom === moment().day(50).format("YYYY-MM-DD")) {
                $("#nextWeekButton").hide();
            } else {
                $("#nextWeekButton").show();
            }
