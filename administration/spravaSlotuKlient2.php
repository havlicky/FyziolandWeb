...
//Pokud jsem to já nebo Jana
if ($resultAdminUser->id == 5 || $resultAdminUser->id == 5) {
    $selectedUser = 'allErgoTherapists';
} else {
...
<div class="container" id="administrace-rezervaci">
    <!--
    <div class="row">
        <div class="col-lg-12 text-center">
            <h3>Rezervace a čekací listina klientů</h3>
        </div>
    </div>
    -->
    ...
    <div class="row">                            
        <div class="col-md-4">
            <div class="form-group">
                <label for="therapists">Terapeutky</label>
                <input type="text" class="form-control" name="therapists" id="therapists"  value="" >
            </div>						
        </div>        
    </div>
    -->
    <div class="row">
        <div class="col-lg-12" style = "margin-top: 15px;" >
            <div class="form-group" >
                    ...
                    <textarea class="form-control"  rows="2" style="width:100%;"  id="clientnotewl" name="clientnotewl" data-form="true" placeholder="">  </textarea>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12">    
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" ><a href="#panel-overview" role="tab" data-toggle="tab">Přehled</a></li>
            <li role="presentation"><a href="#panel-WLparam" role="tab" data-toggle="tab">Nastavení WL</a></li>
            <li role="presentation"><a href="#panel-reservations" role="tab" data-toggle="tab">Rezervace</a></li>
            <li role="presentation"><a href="#panel-WL" role="tab" data-toggle="tab">WL</a></li>		
            <li role="presentation"><a href="#panel-typicalslots" role="tab" data-toggle="tab">Typické sloty</a></li>	
            <li role="presentation"><a href="#panel-parameters" role="tab" data-toggle="tab">Ostatní parametry</a></li>	            
        </ul>
    </div>
    
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade" id="panel-overview">           
            <div class="row" >
                <div class="col-lg-3 col-lg-offset-2  text-left" style = "margin-top:15px;">
                    <a href="#" id="previousWeekButtonOverview">
                        <h4>
                ...
                <div class="col-lg-3 text-center" style = "margin-top:15px;">
                    <a href="#"id="currentWeekButtonOverview">
                        <h4>
                            Aktuální týden
                        </h4>
                    </a>
                ...
                <div class="col-lg-3 text-right" style = "margin-top:15px;">
                    <a href="#" id="nextWeekButtonOverview">
                        <h4>
                            Následující týden
            ...
            <div class="row">
                <div class="col-lg-9 col-lg-offset-2" style = "margin-top:5px;" >
                    <table class="table table-bordered table-striped table-hover" id="tableResWLoverview" style = "font-size:13px;">
                        <thead>
                            <tr>                                            
                                <th class="text-center" style="vertical-align: middle; width: 5%;">Týden od</th>
                                <th class="text-center" style="vertical-align: middle; width: 5%;">Datum</th>
                                <th class="text-center" style="vertical-align: middle; width: 5%;">Den</th>                                
                                <th class="text-center" style="vertical-align: middle; width: 5%;">Čas</th>
                                <th class="text-center" style="vertical-align: middle; width: 30%;">Klient</th>                            
                                <th class="text-center" style="vertical-align: middle; width: 10%;">Služba</th>
                                <th class="text-center" style="vertical-align: middle; width: 5%;">Terapeut</th>
                                <th class="text-center" style="vertical-align: middle; width: 35%;">Týdenní poznámka</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td colspan="8" class="text-center">Nebyly nalezeny žádné rezervace.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div role="tabpanel" class="tab-pane fade" id="panel-WLparam">
             <div class="row">
                <div class="col-lg-12" style = "margin-top: 10px; ">
                    <table class="table table-bordered" id="clientwlparam">
                        <thead>
                            <tr>                
                            ...
                            <?php if (count($results) > 0): ?>
                                    <?php foreach ($results as $result): ?>																	
                                        <tr data-id="<?= $result->service ?>">																												
                                            ...
                                            <td data-field = 'therapists' style = 'text-align: center'> <input type='text' class='form-control' id = 'wl-therapists-<?= $result->service ?>' name='wl-therapists'> </td>
                                            <td data-field = 'activeWL' style = 'text-align: center'> <input type='checkbox'  id = 'wl-activeWL-<?= $result->service ?>' name='wl-activeWL'> </td>
                                            <td data-field = 'urgent' style = 'text-align: center'> <input type='checkbox' id = 'wl-urgent-<?= $result->service ?>' name='wl-urgent'> </td>										
                                            <td data-field = 'freqW' style = 'text-align: center'> <input type='number' min='0' max='10' class='form-control' style = 'width: 60px' id = 'wl-freqW-<?= $result->service ?>' name='wl-freqW'> </td>
                                            <td data-field = 'freqM' style = 'text-align: center'> <input type='number' min='0' max='3' class='form-control'  style = 'width: 60px' id = 'wl-freqM-<?= $result->service ?>' name='wl-freqM'> </td>
                                            <td data-field = 'freqM2' style = 'text-align: center'> <input type='number' min='0' max='12' class='form-control'  style = 'width: 60px' id = 'wl-freqM2-<?= $result->service ?>' name='wl-freqM2'> </td>
                                            <td data-field = 'slottype' style = 'text-align: center'> 
        ...
        <div role="tabpanel" class="tab-pane fade" id="panel-reservations">
            ...
            <div class="row">
                <div class="col-lg-4" style = "margin-top: 15px;">
                    <div class="form-group">
                        ...
                        <select name="therapist" id="therapist" class="form-control" style=" width: 380px;">
                            ...
                            <?php endforeach; ?>
                            <option disabled value="">------------------------</option>                    
                            <option value = 'freeSlotsOnly' value="">Volné termíny</option>
                            <option value = 'freeSlotsEntryOnly' value="">Volné termíny (vstupy)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-4" style = "margin-top: 15px; " align="right">
                    <div class="form-group">
        ...
        <div role="tabpanel" class="tab-pane fade" id="panel-WL">                                                      
             <div class="row">
                <div class="col-lg-12">
                    <div class="form-group" >
                            <label for="clientweeknotewl">Poznámka ke klientovi na daný týden</label>
                            <textarea class="form-control"  rows="2" style="width:100%;"  id="clientweeknotewl" name="clientweeknotewl" data-form="true" placeholder="">  </textarea>
                    </div>
                </div>
            </div>
        ...
        <div role="tabpanel" class="tab-pane fade" id="panel-typicalslots">
            <div class="row">
                <div class="col-lg-12" style = "margin-top: 10px; ">
    ...
    <div style="position: fixed; top: 95px; right: 25px;">


        <div>  
            <!--
            <div class="col-md-4 text-left" style="margin-top: 1px; width: 150px">
                <div class="form-group">                    
                    <input type="text" class="form-control" name="clientname" id="clientname" style="width: auto;" value="">
                </div>
            </div>
...
<script>
    $(document).ready(function() {        
        $('.nav-tabs a[href="#panel-overview"]').click();
       ...
       $("#reservations tbody tr td").click(function() {						                                                                                       
        ...
        document.onkeydown = function(e) {
            ...
            if (event.keyCode === 82 && event.altKey) {
                //písmeno R
                event.preventDefault();
                $('.nav-tabs a[href="#panel-reservations"]').click(); 
            }
            ...
            if (event.keyCode === 78 && event.altKey) {
                //písmeno M
                event.preventDefault();
                $('.nav-tabs a[href="#panel-WLparam"]').click(); 
            }
        }
    });
</script>
