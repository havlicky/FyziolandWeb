...
dalsiKolo:    
    ...
    if($results->resid >0 && $results->client == '') {        
        ...
        //pokud nebyl nalezen id klienta (tzn. klient udělal rezervaci na webu a zatím není v ordinaci - tj. přijde poprvé, tzn. mená ID = nelze ho vybrat v comboboxu na spravuslotuklient a proto jdu na dalšího klienta)
        if ($client->id != null){            
    ...
    //další rezervace v daném dni a v čase v pořadí už neexistuje - je potřeba se posunout na další čas v daném dni nebo již další den   
