...
if (intval($resultAdminUser->isSuperAdmin) !== 1) {
    ...
    $messageBox->addText("Na sekci Správa slotů nemáte oprávnění.");
        ...
        <?php include "menu.php" ?>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h3>Správa dostupných slotů pro individuální rezervace</h3>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="grey text-center" style="vertical-align: middle; cursor: pointer;" data-hour="<?= $hour ?>" data-minute="<?= $minuteFrom ?>" data-time="<?= str_pad($hour, 2, "0", STR_PAD_LEFT) ?>:<?= str_pad($minuteFrom, 2, "0", STR_PAD_LEFT) ?>">
                                <span class="large-device">NEpracuje</span>
            ...
            $(document).ready(function() {
                ...
                function enableCells(table, dataSet) {
                    table.find("td[data-hour]").each(function() {
                        ...
                        $(this).addClass("grey");
                        $(this).find("span.large-device").html("NEpracuje");
                    });
                    ...
                    $.each(dataSet, function(i, obj) {
                        ...
                        table.find("tbody td[data-date='" + date + "'][data-time='" + time + "']").removeClass("grey").addClass("green").find("span.large-device").html("Pracuje");
                    });
                }
