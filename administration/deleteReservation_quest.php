                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 well" style="margin-top: 20px;">
                            ...
                            <div class="form-group" style="text-align: center;">
                                ...
                                <button type="button" style="margin-top: 20px;" class="btn btn-danger" id ="zpet" name="zpet">Nechci mazat rezervaci</button>
                                <button type="submit" style="margin-top: 20px;" class="btn btn-success" name="submitquest">Pokračujte pro smazání rezervace</button>
