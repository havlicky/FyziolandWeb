    ...
    <div class="row" id="ergo-dospeli">
        <div class="row bubliny" style="padding-bottom: 10px;">
            <div class="col-lg-12 text-center">
                <h2><b>Ergoterapie pro dospělé - úprava domácího prostředí</b></h2>
            ...
            <div class="row" style="margin-bottom: 25px">
                <div class="col-lg-4 col-lg-offset-4" id="ergo-text">                
                    ...
                    <b>Již brzy se zde budete moci dočíst o našich službách v oblasti úpravy domácího prostředí. Děkujeme.</b>                    
                </div>                
                <div class="col-lg-4 col-lg-offset-4" id="ergo-text">
