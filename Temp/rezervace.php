            ...
            <div id="tableContainer">
                ...
                <table class="table table-bordered" id="reservations">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td class="text-center" data-hour="<?= $hour ?>" data-minute="<?= $minute ?>">
                            ...
                            ?>
                            <td class="grey text-center" style="vertical-align: middle;" data-hour="<?= $hour ?>" data-minute="<?= $minute ?>" data-time="<?= str_pad($hour, 2, "0", STR_PAD_LEFT) ?>:<?= str_pad($minute, 2, "0", STR_PAD_LEFT) ?>">
...
<script>
    $(document).ready(function() {
        ...
        $("select[name='service'], select[name='person']").change(function() {
            ...
            if (dateFrom === moment().day(36).format("YYYY-MM-DD")) {
                $("#nextWeekButton").hide();
            } else {
                $("#nextWeekButton").show();
            }
