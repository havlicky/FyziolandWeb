            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="top-menu">
                    <ul class="nav navbar-nav">                        
                        <li><a href="#ergo-dospeli">KISS/KiDD</a></li>
    ...
    <div class="row" id="ergo-dospeli">
        <div class="row bubliny" style="padding-bottom: 10px;">
            <div class="col-lg-12 text-center">
                <h2><b>Kiss/Kidd syndrom</b></h2>
                <div class="underline black"></div>
            </div>        
            <div class="row" style="margin-bottom: 25px">
                <div class="col-lg-4 col-lg-offset-4" id="ergo-text">                                        
                    <b>Máte-li zájem o konzultaci nebo terapii dětí s KISS/KiDD syndrom, <br>neváhejte nás kontaktovat na tel. čísle 775 910 749.</b><br><br>
